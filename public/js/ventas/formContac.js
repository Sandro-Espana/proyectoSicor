...
let formContactenos = () => {
  Swal.fire({
    html:
      '<br><br><center><form id="regContactenos" name="regContactenos" class="formSwal" ' +
      ...
      '<input type="text" id="celular" name="celular" class="input" placeholder="Celular" ' +
      'autocomplete="off"><br>' +
      '<label class="label"><b>Correo Electrónico</b></label><br>' +
      '<input type="email" id="correo" name="correo" class="input" placeholder="Correo Electrónico"' +
      'autocomplete="off"><br>' +
      '<label class="label"><b>Mensaje</b></label><br>' +
      '<textarea id="mensaje" name="mensaje" class="input" rows="4" placeholder="Mensaje">' +
      "</textarea><br><br>" +
...
const sendContact = async function (event) {
